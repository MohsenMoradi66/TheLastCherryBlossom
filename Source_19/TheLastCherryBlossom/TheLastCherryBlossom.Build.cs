...
public class TheLastCherryBlossom : ModuleRules
{
	public TheLastCherryBlossom(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore","AIModule", "AnimGraphRuntime", "UMG", "Slate", "SlateCore", "NavigationSystem","UnrealEd" });
